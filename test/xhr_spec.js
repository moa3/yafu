...
describe('XHR', function() {
  ...
  afterEach(function() {
    var base;
    if (typeof (base = jQuery.prop).restore === "function") {
      base.restore();
    }
  ...
  describe('options', function() {
    if (typeof Blob === 'function') {
      return it('calls $.ajax with given options', function() {
        var blob1, blob2, key, options, opts, results, value;
        blob1 = new Blob;
        ...
        for (key in opts) {
          value = opts[key];
          results.push(expect(options[key]).to.eq(value));
        }
        return results;
      });
    }
  ...
  describe('with HTML5 files property', function() {
    if (typeof Blob === 'function') {
      ...
      it('calls $.ajax with default options', function() {
        var key, options, ref, results, value;
        expect(jQuery.prop).to.have.been.calledOnce;
        options = jQuery.ajax.args[0][0];
        ref = this.XHR["default"];
        results = [];
        for (key in ref) {
          value = ref[key];
          results.push(expect(options[key]).to.eq(value));
...
(function() {
  var $, IframeFormData, XHR, addXhrProgressEvent, jQuery, _;
...
},{"./jquery.iframe-transport":2,"jquery":3,"underscore":4}],7:[function(require,module,exports){
(function (global){
...
},{"./file_input":1,"./jquery.iframe-transport":2,"./xhr":6,"jquery":3,"underscore":4}]},{},[5]);
